    ...
    <div class="flex min-h-24 flex-wrap items-center justify-between gap-4 border-b border-cyan-400/25 bg-cyan-950/60 px-5 py-4">
      ...
      <div class="flex flex-wrap items-end gap-3">
        <label class="grid gap-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-cyan-100">
          <span>Category</span>
          <select v-model="selectedCategory" class="h-10 w-56 rounded-md border border-cyan-400/35 bg-slate-950/90 px-3 text-sm font-normal normal-case tracking-normal text-cyan-50 outline-none focus:border-cyan-200">
